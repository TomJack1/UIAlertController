#
#  Be sure to run `pod spec lint LEAlertController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/LEAlertController"
  ...
  s.source       = { :git => "https://github.com/TomJack1/UIAlertController.git", :tag => "#{s.version}" }
